...
import { saveRegistry as saveSkillRegistry } from "../skill/registry.js";
import type { InstalledSkill, SkillContext } from "../skill/types.js";
import { loadRegistry as loadToolRegistry, saveRegistry as saveToolRegistry } from "../tool/registry.js";
...
describe("rollbackChange", () => {
  ...
  it("rolls back a skill_remove using skill snapshot", async () => {
    ...
    const { createSnapshot } = await import("../skill/snapshot.js");
    ...
    const { loadRegistry: loadSkillReg } = await import("../skill/registry.js");
