...
[[clawhq-vs-alternatives]] relies on.
...
- [[blueprint-system]] — what gets deployed.
- [[lifecycle-management-gap]] — why this architecture
  exists at all.
- [[threat-model]] — the agent-level security model
