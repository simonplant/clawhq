...
status: active
date: 2026-04-22
tags: [clawhq, analogy, positioning, concept]
sources:
...
- **Encodes** the 14 landmines, the three hardening postures, the
  ...
  everything in [[production-discoveries]].
...
- [[lifecycle-management-gap]] — the specific gaps
  ClawHQ fills.
- [[clawhq-vs-alternatives]] — how this positioning
