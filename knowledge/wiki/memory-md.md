...
status: active
date: 2026-04-22
tags: [memory, long-term, curation, openclaw, component]
sources:
...
[[memory-system]] two-layer architecture. Daily logs
...
See [[memory-search]] for configuration.
...
[[memory-system]]. MEMORY.md itself sits in the hot
