...
location: "src/build/docker/posture.ts"
sources:
...
see_also:
  ...
  - openclaw/landmine/container-user-not-uid-1000.md
  - openclaw/landmine/icc-enabled-on-agent-network.md
  - openclaw/landmine/config-credentials-not-read-only.md
tags: [docker, hardening, security, posture]
---
...
| Control | Prevents |
|---|---|
| `user: "1000:1000"` | [[openclaw/landmine/container-user-not-uid-1000]] |
| `cap_drop: ALL` + `no-new-privileges` | Privilege escalation attacks |
| `read_only: true` on rootfs | Runtime binary modification |
| Read-only config/creds mounts | [[openclaw/landmine/config-credentials-not-read-only]] |
| ICC disabled on networks | [[openclaw/landmine/icc-enabled-on-agent-network]] |
| Egress firewall reapply | [[openclaw/landmine/firewall-not-reapplied-after-network-recreate]] |
| Pre-created networks | [[openclaw/landmine/external-networks-not-created]] |
