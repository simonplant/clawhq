...
status: active
severity: high
affects: "All deployments with substantial SOUL.md / AGENTS.md / USER.md content"
...
tags: [workspace, truncation, bootstrap, silent-failure]
landmine_number: 8
---
...
auto-loaded files (see [[openclaw/concept/system-prompt-assembly]]). Without
