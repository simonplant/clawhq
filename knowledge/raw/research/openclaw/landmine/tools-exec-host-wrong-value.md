...
status: active
severity: critical
affects: "All deployments using the exec tool"
...
see_also:
  ...
  - openclaw/component/exec-tool.md
  - openclaw/landmine/tools-exec-security-not-full.md
tags: [exec, tools, docker, silent-failure]
landmine_number: 4
---
...
Also verify [[openclaw/landmine/tools-exec-security-not-full]] — these two
