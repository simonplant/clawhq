...
status: active
severity: high
affects: "All deployments using integrations (email, calendar, tasks, etc.)"
...
tags: [env-vars, integrations, silent-failure, credentials]
landmine_number: 11
---
...
[[openclaw/security/credential-health-probes]]) catch rotations that
