...
status: active
severity: high
affects: "Docker deployments running multiple agent containers"
...
tags: [docker, networking, isolation, security]
landmine_number: 7
---
...
[[openclaw/security/egress-firewall]]) for the complete isolation model:
