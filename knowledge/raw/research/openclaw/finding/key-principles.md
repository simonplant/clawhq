...
tags: [principles, philosophy, operations]
---
...
[[openclaw/concept/files-are-the-agent]].
...
leads to drift — see [[openclaw/component/soul-md]] and
[[openclaw/component/agents-md]] for the boundaries.
...
[[openclaw/concept/memory-system]].
...
See [[openclaw/security/threat-model]].
...
- Use isolated cron sessions instead of native heartbeat (see
  [[openclaw/component/heartbeat-md]] on the 170–210k input tokens
  per run observation).
