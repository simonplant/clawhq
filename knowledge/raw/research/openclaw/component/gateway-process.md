...
- **Auto-reply router** — access control, session resolve, agent
  dispatch. See [[openclaw/component/auto-reply-router]].
...
emitted by the wizard. The [[openclaw/operation/golden-config-pattern]]
is the mitigation.
