...
location: "src/operate/doctor/checks.ts + src/operate/doctor/fix.ts"
sources:
...
tags: [diagnostics, doctor, health, operations]
---
...
| `clawhq creds` | Credential health probes. See [[openclaw/security/credential-health-probes]] |
